...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-0 z-50 grid w-full max-w-full gap-4 border-0 bg-transparent shadow-2xl duration-200',
        'sm:left-[50%] sm:w-[93%] sm:translate-x-[-50%] sm:top-[5%] sm:bottom-[5%]',
        'md:left-[50%] md:w-4/5 md:translate-x-[-50%]',
