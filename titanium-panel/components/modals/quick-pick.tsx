...
export const QuickPickModal = () => {
  const quickPickModal = useQuickPickModal();
  ...
  return (
    <Modal
      title="QuickPick"
      description="Manage your assets and resources."
      isOpen={quickPickModal.isOpen}
      onClose={quickPickModal.onClose}
      size="lg"
      height="50%"
    >
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="pt-6 space-x-2 flex items-center justify-end w-full">
                <Button
                  disabled={loading}
                  variant="outline"
                  onClick={quickPickModal.onClose}
                >
                  Cancel
                </Button>
